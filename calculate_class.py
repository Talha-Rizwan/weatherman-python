...
class Calculator :
    ...
    def compute_the_sum_of_all_rows(self, temperature_sum_values, daily_temperature_values):
        self.compute_sum_of_single_attribute(daily_temperature_values, temperature_sum_values, 'highest_temperature')
        self.compute_sum_of_single_attribute(daily_temperature_values, temperature_sum_values, 'lowest_temperature')
        self.compute_sum_of_single_attribute(daily_temperature_values, temperature_sum_values, 'maximum_humidity')
    

    def compute_sum_of_single_attribute(self, daily_temperature_values, temperature_sum_values, key_attribute ):
    ...
    def calculate_mean_temperature(self, temperature_sum_values):
        ...
        mean_result_values['highest_temperature_mean'] = self.Calculate_mean( temperature_sum_values['highest_temperature']['sum'], 
                                                                            temperature_sum_values['highest_temperature']['count'] )
        mean_result_values['lowest_temperature_mean'] = self.Calculate_mean(temperature_sum_values['lowest_temperature']['sum'],
                                                                            temperature_sum_values['lowest_temperature']['count'] ) 
        mean_result_values['maximum_humidity_mean'] = self.Calculate_mean( temperature_sum_values['maximum_humidity']['sum'], 
    ...
    def compare_temperature_for_single_attribute_of_monthly_to_yearly(self, monthly_temperature_values, 
                                                                    yearly_temperature_values, 
                                                                    key_attribute):

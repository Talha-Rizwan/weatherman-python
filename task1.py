    ...
    if len(arguments) > 2:
        ...
        for i in range(1,13):
            ...
            if os.path.exists(path):
                # Calculate_extreme_temperatures(path)
                file_path = path
                ...
                with open(file_path,'r') as file:
                    ...
                    for line in file:
                        ...
                        print("the max temperature is : ", max_year_humidity)
...
def Calculate_extreme_temperatures(path):
    ...
    with open(file_path,'r') as file:
        ...
        # if monthly_max_lowest_temperature < max_lowest_year_temperature_date:
        #     lowest_year_temperature=monthly_max_lowest_temperature
        #     max_lowest_year_temperature_date=monthly_max_lowest_temperature_date
